namespace eval ::hprefstruct:: {
        ...
        variable molprobity_path /home_orig/chaoyi/builds/phenix-1.17.1-3660/build/bin
        proc check_install { } {
...
proc ::hprefstruct::printBash3 { pdb } {
    variable rosetta_bin
    variable rosetta_db
    variable iter
    set op [open rosetta.run${iter}.sh w]
...
proc ::hprefstruct::hprs { args } {
	...
	for {set i $start} {$i <= 4} {incr i} {
		...
		::hprefstruct::printBash3 ${jobname}.pdb 
